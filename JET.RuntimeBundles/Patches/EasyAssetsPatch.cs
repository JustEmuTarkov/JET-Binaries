...
using BundleLock = GClass2059; //Property: MaxConcurrentOperations
using DependencyGraph = GClass2097<GInterface223>; // Method: GetDefaultNode()

namespace JET.RuntimeBundles.Patches
{
